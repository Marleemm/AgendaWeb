...
<head>
    ...
    <style>
        body {
            background-color: rgb(240, 240, 240); /* Color de fondo general */
        }
        .form-container {
            background-color: rgb(158, 136, 177); /* Color morado de fondo */
            padding: 20px;
            border-radius: 8px;
        ...
        .btn-primary {
            background-color: white; /* Botón de guardar en blanco */
            color: rgb(158, 136, 177); /* Texto del botón en morado */
        }
        .btn-primary:hover {
            background-color: rgb(140, 120, 155); /* Hover en el botón */
        }
        .btn-secondary {
            background-color: rgba(255, 255, 255, 0.5); /* Botón de cancelar en blanco con opacidad */
            color: rgb(158, 136, 177); /* Texto del botón en morado */
        }
        .btn-secondary:hover {
            background-color: rgba(255, 255, 255, 0.8); /* Hover en el botón */
        }
    </style>
