                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="btn-filtrar" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="imagenes/filtrar.png" alt="filtro" height="45px" width="50px">
                        </a>
                    ...
                    <a class="nav-link" id="btn-editar"><img src="imagenes/editar.png" alt="editar" height="40px" width="50px"></a>
                    <a class="nav-link" id="btn-eliminar"><img src="imagenes/borrar.png" alt="borrar" height="40px" width="50px"></a>
            ...
            <div class="principal">
                ...
                <div class="container">
                    ...
                    <form id="eliminar-contactos-form" method="POST" action="controlador.php">
                        ...
                        <div class=" row g-4 py-5 row-cols-3 row-cols-lg-3 " id="lista">
...
<div> 
    <p class="roboto-mono">Favoritos</p>
            <div class="favCuadro">
                ...
                <div class="row g-4 py-5 row-cols-3 row-cols-lg-1 border-color:" dark" id="listano">
